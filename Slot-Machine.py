...
def spin_payout(reel_1, reel_2, reel_3):
    if reel_1 == 5 and reel_2 == 5 and reel_3 == 5:
        ...
        return 10
    elif (reel_1 == 4 and reel_2 == 4) or (reel_1 == 4 and reel_3 == 4) or (reel_2 == 4 and reel_3 == 4):
        return 5
    else:
        return 0
...
#last message in brackets was {:-6d}
...
def simulate(n):
    ...
    for i in range(0, n + 1, 1):
        ...
        payout += spin_payout(reel_1, reel_2, reel_3) * .01
    payout /= (n * .05)
    print("For every $1 spent, you can expect to win ", round(payout, 2)) 
